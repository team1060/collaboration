...
function UploadFile({ handleImageUpload }) {
  ...
  const previewImages = previews.map((preview, i) => (
    <div key={i}>
      <div>
        <img src={preview.imgSrc} alt="" style={{ width: 300, height: 300, objectFit: 'cover' }} />
    ...
    <>
      ...
      <form onSubmit={onSubmit}>
        <div className="fileView">
          {fileName}
          <input type="file" name="images" id="inp" multiple onChange={imageSelectHandler} accept="images/*" />
        </div>
